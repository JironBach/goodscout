...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { company_id: @inquiry.company_id, desc: @inquiry.desc, how_to_reply: @inquiry.how_to_reply, title: @inquiry.title }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { company_id: @inquiry.company_id, desc: @inquiry.desc, how_to_reply: @inquiry.how_to_reply, title: @inquiry.title }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
